...
void TutorialGame::MovePlayer(GameObject* player, float dt) {
	...
	if (Window::GetKeyboard()->KeyDown(KeyboardKeys::W)) {
		if ((timedetection == 0 || timedetection >= 2.0f) && player->IsGrounded() && directionInput == false) {
			timedetection = 0;////////////////////////////////////////////////////////////////////////////
	...
	if (Window::GetKeyboard()->KeyPressed(KeyboardKeys::SPACE) && player->IsGrounded()) {
		Vector3 playerjumppos = player->GetPhysicsObject()->getTransform().getPosition();//////////////////////////////////////////////////
		Vector3 jumpposition = playerjumppos - world->GetMainCamera()->GetPosition();//////////////////////////////////////////////////
		ISoundEngine* run = createIrrKlangDevice();///////////////////////////////////////////////////////////////////////////
	...
	if (Window::GetMouse()->ButtonDown(NCL::MouseButtons::LEFT) && (timedetection2 == 0 || timedetection2 >=0.2f)) {//////////////////////////////////////////////////
		timedetection2 = 0;
		...
		Vector3 hitposition = sphereintipos - world->GetMainCamera()->GetPosition();//////////////////////////////////////////////////
		ISoundEngine* fire = createIrrKlangDevice();/////////////////////////////////////////////
		firevoice->ShootVoice(fire, hitposition);////////////////////////////////////////////////////////////////
...
void TutorialGame::PlayerPaintTracks() {
	if (player->IsGrounded() && true) {
		//std::cout << player->collisionPoint << std::endl;
		float distance = sqrt(pow(player->collisionPoint.x - currentPos.x, 2) + pow(player->collisionPoint.z - currentPos.z, 2));
		if (distance > 1) {
			floor->GetRenderObject()->PaintSpray(player->collisionPoint);
			currentPos = player->collisionPoint;
		}
	}
}
