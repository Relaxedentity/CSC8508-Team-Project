...
class GameScreen : public PushdownState {
	...
	PushdownResult OnUpdate(float dt,
		...
		while (w->UpdateWindow()) {
			...
			ISoundEngine* BackGroundMusic;
			w->SetTitle("Gametech frame time:" + std::to_string(1000.0f * dt));
			string FPS = std::to_string(int(1/dt));////////////////////////////
			Debug::Print("FPS:"+FPS, Vector2(25, 95), Debug::WHITE);////////////////////////////////
			if (begin == 0) {/////////////////////////////////////////
				music1->MainMusic(backgroundmusic);///////////////////////////////////////
				begin++;/////////////////////////////////////
			}
			else  if (Window::GetKeyboard()->KeyPressed(KeyboardKeys::M) && begin == 1) {
